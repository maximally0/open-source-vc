...
| [Due Diligence Agents](https://github.com/zoharbabin/due-diligence-agents) | Agents that flag risks across legal and finance and link them. | Due Diligence | 104 |
...
| [VC Reporting](https://github.com/tdavidson/reporting) | An AI-native platform for fund reporting and analysis. | Investment Memo & IC | 53 |
...
| [Sherlock](https://github.com/sherlock-project/sherlock) | VC-adaptable | Founder & Talent Discovery | 91.5k | MIT | When a founder's name is common or their LinkedIn is thin, an analyst runs the handle they use elsewhere through Sherlock to see where else that handle exists. |
| [OpenBB](https://github.com/OpenBB-finance/OpenBB) | VC-adaptable | Investment Analysis | 73k | unverified (Other) | Public comparables work: pull financials, prices, and fundamentals for the listed companies a target competes with, then build the trading multiples that anchor a valuation conversation. |
| [NocoDB](https://github.com/nocodb/nocodb) | VC-adaptable | Deal Sourcing & Pipeline | 65k | unverified (Other) | The deals pipeline most small funds actually need: stages, owners, next actions, and notes, as a grid anyone on the team can edit, sitting on a real database you control. |
| [Twenty](https://github.com/twentyhq/twenty) | VC-adaptable | Relationship Intelligence | 56.7k | unverified (Other) | The team version: contacts, companies, and opportunities that match how a fund works, in a shared system rather than four analysts' personal notes. |
...
| [Paperless-ngx](https://github.com/paperless-ngx/paperless-ngx) | VC-adaptable | Data Rooms & Document Intelligence | 45.1k | GPL-3.0 | The document archive for a fund or a family office: every contract, statement, and filing OCR'd, tagged, and full-text searchable, with the original file retained. |
...
| [changedetection.io](https://github.com/dgtlmoon/changedetection.io) | VC-adaptable | Deal Sourcing & Pipeline | 34.1k | Apache-2.0 | The narrow version of monitoring and the one analysts actually need: a competitor drops a price, adds a plan, edits a terms page, or a portfolio company quietly reshuffles its team page. |
...
| [Arelle](https://github.com/Arelle/Arelle) | VC-adaptable | Standards & Schemas | 238 | unverified (Other) | XBRL is how financial statements arrive from public companies and increasingly from private reporting. |
| [Docling](https://github.com/docling-project/docling) | Infrastructure | Data Rooms & Document Intelligence | 66.4k | MIT | Financial statements and contracts are where layout carries meaning: which number sits in which column, which heading a clause falls under. |
...
| [OCRmyPDF](https://github.com/ocrmypdf/OCRmyPDF) | Infrastructure | Data Rooms & Document Intelligence | 34.8k | MPL-2.0 | The unglamorous step that makes everything else possible. |
