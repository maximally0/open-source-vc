...
One row per curated project, flattened so you can sort and filter it. This is the page to open when you are choosing between three tools that all claim to do the same thing.

**How to read it**

- **Relevance** — whether the project was built for venture, adapted to it, or is a generic building block. This is deliberately independent of quality: a document parser can be the best tool here for a data room and still have no idea what a data room is. See [METHODOLOGY.md](METHODOLOGY.md#vc-relevance).
- **OSS** — the licence as published upstream. `unverified` means the repo has no detectable licence file, so treat redistribution as off-limits. See [METHODOLOGY.md](METHODOLOGY.md#licensing).
- **Self-host** — can you run it on your own infrastructure without a paid tier. `partial` means an open core with commercial hosted extras.
...
|---|---|---|---|---|---|---|---|---:|---|
| [Captable](https://github.com/captableinc/captable) | [Cap Tables & Equity](categories/cap-tables.md) | Essential | VC-native | AGPL-3.0 | yes | No | software | 822 | Cap table management |
| [YC Open API](https://github.com/yc-oss/api) | [Company Discovery & Deal Sourcing](categories/company-discovery.md) | Essential | VC-native | unknown | yes | No | dataset | 231 | Cohort analysis |
...
| [yfinance](https://github.com/ranaroussi/yfinance) | [Investment Analysis](categories/investment-analysis.md) | Essential | VC-adaptable | Apache-2.0 | yes | No | software | 25.2k | Market data |
| [SingleFile](https://github.com/gildas-lormeau/SingleFile) | [Web Intelligence & OSINT](categories/osint.md) | Essential | VC-adaptable | AGPL-3.0 | yes | No | software | 22.4k | Evidence capture |
| [PaperQA](https://github.com/Future-House/paper-qa) | [Due Diligence](categories/due-diligence.md) | Essential | VC-adaptable | Apache-2.0 | yes | Yes | software | 9.2k | Technical due diligence |
...
| [deep-research](https://github.com/dzhng/deep-research) | [Market & Industry Research](categories/market-research.md) | Recommended | VC-adaptable | MIT | yes | Yes | software | 19.7k | Learning agent design |
| [DocuSeal](https://github.com/docusealco/docuseal) | [Data Rooms & Document Intelligence](categories/document-intelligence.md) | Recommended | VC-adaptable | AGPL-3.0 | partial | No | software | 18.5k | Deal closing |
...
| [OSINT Framework](https://github.com/lockfale/OSINT-Framework) | [Founder & Talent Discovery](categories/founder-discovery.md) | Recommended | VC-adaptable | MIT | yes | No | software | 12.1k | Source discovery |
...
| [OpenCTI](https://github.com/OpenCTI-Platform/opencti) | [Web Intelligence & OSINT](categories/osint.md) | Recommended | VC-adaptable | unverified (Other) | yes | No | software | 10k | Entity tracking |
| [Star History](https://github.com/star-history/star-history) | [Company Discovery & Deal Sourcing](categories/company-discovery.md) | Recommended | VC-adaptable | MIT | yes | No | software | 9.5k | GitHub signals |
...
| [Osmedeus](https://github.com/j3ssie/osmedeus) | [Web Intelligence & OSINT](categories/osint.md) | Recommended | VC-adaptable | MIT | yes | No | software | 6.6k | Repeatable screening |
| [Ledger](https://github.com/ledger/ledger) | [LP & Fund Management](categories/lp-management.md) | Recommended | VC-adaptable | unverified (Other) | yes | No | software | 6k | Fund accounting |
| [PyPortfolioOpt](https://github.com/PyPortfolio/PyPortfolioOpt) | [LP & Fund Management](categories/lp-management.md) | Recommended | VC-adaptable | MIT | yes | No | framework | 6k | Portfolio construction |
| [Beancount](https://github.com/beancount/beancount) | [LP & Fund Management](categories/lp-management.md) | Recommended | VC-adaptable | GPL-2.0 | yes | No | software | 6k | Fund accounting |
...
| [OSS Insight](https://github.com/pingcap/ossinsight) | [Company Discovery & Deal Sourcing](categories/company-discovery.md) | Recommended | VC-adaptable | Apache-2.0 | yes | No | software | 2.5k | GitHub signals |
...
| [Brel](https://github.com/BrelLibrary/brel) | [Standards & Schemas](categories/standards.md) | Experimental | VC-adaptable | unverified (Other) | yes | No | software | 45 | XBRL parsing |
| [OpenCLI](https://github.com/bcdxn/opencli) | [Standards & Schemas](categories/standards.md) | Experimental | VC-adaptable | MIT | yes | No | standard | 44 | Agent tooling |
| [XBRL Parser](https://github.com/massive-com/xbrl-parser) | [Standards & Schemas](categories/standards.md) | Experimental | VC-adaptable | MIT | yes | No | software | 39 | Go pipelines |
| [Digital Template to XBRL Converter](https://github.com/EFRAG-EU/Digital-Template-to-XBRL-Converter) | [Standards & Schemas](categories/standards.md) | Experimental | VC-adaptable | MIT | yes | No | software | 38 | ESG reporting |
| [iXBRL Reporter](https://github.com/cybermaggedon/ixbrl-reporter) | [Standards & Schemas](categories/standards.md) | Experimental | VC-adaptable | GPL-3.0 | yes | No | software | 35 | Regulatory reporting |
| [DocuChat](https://github.com/janderswag/docuchat.app) | [Legal & Transaction Infrastructure](categories/legal.md) | Experimental | VC-adaptable | MIT | yes | Yes | software | 33 | Privileged documents |
| [OpenSpecter](https://github.com/akashshrx/OpenSpecter) | [Legal & Transaction Infrastructure](categories/legal.md) | Experimental | VC-adaptable | AGPL-3.0 | yes | Yes | software | 31 | Legal workspace |
| [TickerToThesis](https://github.com/jasonfdg/TickerToThesis) | [Investment Memo & IC](categories/investment-memos.md) | Experimental | VC-adaptable | unknown | yes | Yes | software | 26 | Memo drafting |
| [PatentsView](https://github.com/PatentsView/PatentsView-API) | [Datasets & Open Data](categories/datasets.md) | Experimental | VC-adaptable | BSD-2-Clause | yes | No | dataset | 20 | IP research |
| [OpenRegistry](https://github.com/sophymarine/openregistry) | [Company Discovery & Deal Sourcing](categories/company-discovery.md) | Experimental | VC-adaptable | Apache-2.0 | yes | No | software | 18 | Entity verification |
| [OpenAlex API](https://github.com/ourresearch/openalex-api) | [Datasets & Open Data](categories/datasets.md) | Experimental | VC-adaptable | MIT | yes | No | dataset | 8 | Founder vetting |
...
| [DSPy](https://github.com/stanfordnlp/dspy) | [AI Agents for VC](categories/ai-agents.md) | Recommended | Infrastructure | MIT | yes | Yes | framework | 38k | Prompt maintenance |
| [Directus](https://github.com/directus/directus) | [Portfolio Management](categories/portfolio-management.md) | Recommended | Infrastructure | unverified (Other) | partial | No | software | 37.9k | Internal systems |
...
| [Chroma](https://github.com/chroma-core/chroma) | [Knowledge Management](categories/knowledge-management.md) | Recommended | Infrastructure | Apache-2.0 | yes | Yes | software | 29.3k | Prototyping |
| [Kestra](https://github.com/kestra-io/kestra) | [Workflow & Automation](categories/automation.md) | Recommended | Infrastructure | Apache-2.0 | yes | No | software | 28.1k | Scheduled research |
| [Haystack](https://github.com/deepset-ai/haystack) | [Knowledge Management](categories/knowledge-management.md) | Recommended | Infrastructure | Apache-2.0 | yes | Yes | framework | 26.5k | Pipeline evaluation |
| [Crawlee](https://github.com/apify/crawlee) | [Web Intelligence & OSINT](categories/osint.md) | Recommended | Infrastructure | Apache-2.0 | yes | No | framework | 25.8k | JS-heavy collection |
| [faster-whisper](https://github.com/SYSTRAN/faster-whisper) | [Relationship Intelligence](categories/relationship-intelligence.md) | Recommended | Infrastructure | MIT | yes | Yes | software | 25.4k | Batch transcription |
| [Activepieces](https://github.com/activepieces/activepieces) | [Workflow & Automation](categories/automation.md) | Recommended | Infrastructure | unverified (Other) | partial | Yes | software | 24.4k | Open automation |
...
| [Windmill](https://github.com/windmill-labs/windmill) | [Workflow & Automation](categories/automation.md) | Recommended | Infrastructure | unverified (Other) | partial | No | software | 17.9k | Internal tooling |
| [NetworkX](https://github.com/networkx/networkx) | [Relationship Intelligence](categories/relationship-intelligence.md) | Recommended | Infrastructure | unverified (Other) | yes | No | framework | 17.3k | Warm introduction paths |
| [Neo4j](https://github.com/neo4j/neo4j) | [Knowledge Management](categories/knowledge-management.md) | Recommended | Infrastructure | GPL-3.0 | partial | No | software | 17.2k | Relationship graphs |
| [Weaviate](https://github.com/weaviate/weaviate) | [Knowledge Management](categories/knowledge-management.md) | Recommended | Infrastructure | unverified (Other) | yes | Yes | software | 16.8k | Hybrid search |
| [Dagster](https://github.com/dagster-io/dagster) | [Workflow & Automation](categories/automation.md) | Recommended | Infrastructure | Apache-2.0 | yes | No | software | 16.1k | Data quality |
| [dbt](https://github.com/dbt-labs/dbt) | [Workflow & Automation](categories/automation.md) | Recommended | Infrastructure | Apache-2.0 | yes | No | framework | 13.8k | Data modelling |
| [txtai](https://github.com/neuml/txtai) | [Knowledge Management](categories/knowledge-management.md) | Recommended | Infrastructure | Apache-2.0 | yes | Yes | framework | 12.9k | Internal search |
| [Chandra](https://github.com/datalab-to/chandra) | [Data Rooms & Document Intelligence](categories/document-intelligence.md) | Recommended | Infrastructure | Apache-2.0 | yes | Yes | software | 12.3k | Complex tables |
| [pdfplumber](https://github.com/jsvine/pdfplumber) | [Data Rooms & Document Intelligence](categories/document-intelligence.md) | Recommended | Infrastructure | MIT | yes | No | software | 10.7k | Targeted extraction |
| [PyMuPDF](https://github.com/pymupdf/PyMuPDF) | [Data Rooms & Document Intelligence](categories/document-intelligence.md) | Recommended | Infrastructure | AGPL-3.0 | yes | No | software | 10.7k | PDF manipulation |
| [Quarto](https://github.com/quarto-dev/quarto-cli) | [Investment Memo & IC](categories/investment-memos.md) | Recommended | Infrastructure | unverified (Other) | yes | No | software | 6k | Reproducible reports |
| [TensorFlow Datasets](https://github.com/tensorflow/datasets) | [Datasets & Open Data](categories/datasets.md) | Recommended | Infrastructure | Apache-2.0 | yes | Yes | framework | 4.6k | Dataset management |
| [Jupyter Book](https://github.com/jupyter-book/jupyter-book) | [Knowledge Management](categories/knowledge-management.md) | Recommended | Infrastructure | BSD-3-Clause | yes | No | software | 4.3k | Publishing research |
| [Apache Tika](https://github.com/apache/tika) | [Data Rooms & Document Intelligence](categories/document-intelligence.md) | Recommended | Infrastructure | Apache-2.0 | yes | No | software | 4.1k | Format triage |
| [Camelot](https://github.com/camelot-dev/camelot) | [Data Rooms & Document Intelligence](categories/document-intelligence.md) | Recommended | Infrastructure | MIT | yes | No | software | 3.8k | Financial tables |
| [ROAPI](https://github.com/roapi/roapi) | [Portfolio Management](categories/portfolio-management.md) | Recommended | Infrastructure | Apache-2.0 | yes | No | software | 3.4k | Internal APIs |
| [Meltano](https://github.com/meltano/meltano) | [Workflow & Automation](categories/automation.md) | Recommended | Infrastructure | MIT | yes | No | software | 2.6k | Data ingestion |
...
`metadata/repositories.json` carries every field as structured data, so you can rebuild any view you want:
