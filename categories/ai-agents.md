...
`browser-use/browser-use` &nbsp;·&nbsp; ⭐ **Essential** &nbsp;·&nbsp; _framework_
...
`modelcontextprotocol/servers` &nbsp;·&nbsp; ⭐ **Essential** &nbsp;·&nbsp; _framework_
...
`run-llama/llama_index` &nbsp;·&nbsp; ⭐ **Essential** &nbsp;·&nbsp; _framework_
...
`langchain-ai/langgraph` &nbsp;·&nbsp; ⭐ **Essential** &nbsp;·&nbsp; _framework_
...
`langgenius/dify` &nbsp;·&nbsp; 🔥 **Interesting** &nbsp;·&nbsp; _software_
...
`langchain-ai/langchain` &nbsp;·&nbsp; 🔥 **Interesting** &nbsp;·&nbsp; _framework_
...
`punkpeye/awesome-mcp-servers` &nbsp;·&nbsp; 🔥 **Interesting** &nbsp;·&nbsp; _software_
...
`OpenHands/OpenHands` &nbsp;·&nbsp; 🔥 **Interesting** &nbsp;·&nbsp; _software_
...
`microsoft/autogen` &nbsp;·&nbsp; 🔥 **Interesting** &nbsp;·&nbsp; _framework_
...
`crewAIInc/crewAI` &nbsp;·&nbsp; 🔥 **Interesting** &nbsp;·&nbsp; _framework_
...
`stanfordnlp/dspy` &nbsp;·&nbsp; 🔥 **Interesting** &nbsp;·&nbsp; _framework_
...
`openai/openai-agents-python` &nbsp;·&nbsp; 🔥 **Interesting** &nbsp;·&nbsp; _framework_
...
`heurist-network/heurist-agent-framework` &nbsp;·&nbsp; 🧪 **Experimental** &nbsp;·&nbsp; _framework_
...
`Significant-Gravitas/AutoGPT` &nbsp;·&nbsp; 📚 **Research** &nbsp;·&nbsp; _software_
